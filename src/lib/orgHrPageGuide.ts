...
const guides: Record<string, OrgHrPageGuide> = {
  ...
  "/org/hr/ess/leave-requests": buildGuide({
    badge: "ESS",
    title: "Panduan Cuti & Izin ESS",
    summary:
      "Halaman ini membantu HR memantau permohonan cuti/izin yang datang dari kanal layanan mandiri pegawai tanpa menjadikannya jalur self-service personal yang terpisah.",
    focusPoints: [
      "Meninjau permohonan cuti yang datang dari kanal ESS.",
      "Mengecek keterkaitan pengajuan dengan kuota dan jenis cuti.",
      "Menjaga respons HR tetap konsisten dengan alur persetujuan dan kebijakan tenant.",
    ],
    useCases: [
      "Saat HR perlu memonitor pengajuan cuti pegawai dari kanal ESS.",
      "Saat ada ketidaksesuaian antara pengajuan dan saldo cuti.",
      "Saat perlu melihat konteks ESS sebelum masuk ke alur persetujuan cuti utama.",
    ],
    outputs: [
      "Daftar pengajuan cuti ESS yang relevan untuk dipantau.",
      "Status tindak lanjut permohonan dalam konteks HR.",
    ...
    watchouts: [
      ...
      "Gunakan halaman ini sebagai lensa ESS; jika perlu triase administratif penuh, cek persetujuan cuti utama juga.",
    ],
    relatedRoutes: [
  ...
  "/org/hr/ess/wfh-requests": buildGuide({
    badge: "ESS",
    title: "Panduan Pengajuan WFH",
    summary:
      "Halaman ini dipakai untuk meninjau pengajuan kerja dari rumah yang datang dari kanal pegawai, tetapi tetap memakai mekanisme persetujuan organisasi yang sama.",
    focusPoints: [
  ...
  "/org/hr/ess/flexible-attendance": buildGuide({
    badge: "ESS",
    title: "Panduan Absensi Khusus",
    summary:
      "Halaman ini meninjau permohonan absensi fleksibel atau non-standar dari pegawai dengan alur kerja organisasi yang sama, tetapi dibuka dari konteks HR.",
    focusPoints: [
  ...
  "/org/hr/ess/overtime-requests": buildGuide({
    badge: "ESS",
    title: "Panduan Pengajuan Lembur",
    summary:
      "Halaman ini meninjau pengajuan lembur pegawai dari kanal layanan mandiri, tetapi tetap memakai permintaan, status, dan riwayat persetujuan yang sama dengan modul organisasi.",
    focusPoints: [
