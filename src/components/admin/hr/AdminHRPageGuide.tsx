...
import { getAdminHrPageGuide } from "@/lib/adminHrPageGuide";

type AdminHRPageGuideProps = {
  pathname: string;
};

export function AdminHRPageGuide({ pathname }: AdminHRPageGuideProps) {
  const guide = getAdminHrPageGuide(pathname);
