-- Preserve original attendance event timestamp from device payload.
-- This ensures deferred/queued replay keeps the actual check-in/check-out time
-- instead of worker processing time.
