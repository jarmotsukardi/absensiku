-- Protect selected tenant codes from unpaid cleanup purge flow (default: KAB2512015 / Maluku Tengah test tenant)

INSERT INTO public.system_settings (key, value, description)
VALUES (
  'unpaid_cleanup_protected_tenant_codes',
  '{"codes":["KAB2512015"]}'::jsonb,
  'Daftar kode tenant yang dikecualikan dari unpaid cleanup lifecycle'
)
